...
def generate_sdf(filename, directory, num_objects, range_min, range_max, num_male, num_female, num_chair):
...
if __name__ == "__main__":
    ...
    generate_sdf(args.filename, args.directory, args.num_objects, args.range_min, args.range_max, args.num_male, args.num_female, args.num_chair)
